  ...
  return (
    <footer className="bg-green-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social, index) => (
                <motion.a
                  key={social.name}
                  href={social.href}
                  className={`${social.color} w-10 h-10 rounded-full flex items-center justify-center transition-colors`}
          ...
          >
            ...
            <ul className="space-y-4">
              ...
              >
                ...
                <span className="text-green-100 text-sm">info@w2wadvisors.in</span>
              </motion.li>
              <motion.li
                className="flex items-start gap-3"
                initial={{ opacity: 0, x: -20 }}
              ...
              >
                ...
                <span className="text-green-100 text-sm">+91 74286 98688</span>
              </motion.li>
              <motion.li
                className="flex items-start gap-3"
                initial={{ opacity: 0, x: -20 }}
              ...
              >
                ...
                <span className="text-green-100 text-sm">246 2nd Floor JMD Megapolis Sector 47 Gurgaom</span>
              </motion.li>
            </ul>
          </motion.div>
        </div>
        ...
        {/* Bottom Bar */}
        <motion.div
          className="border-t border-green-700 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4"
          initial={{ opacity: 0 }}
        ...
        >
          <p className="text-green-200 text-sm">
            © 2025 Work Well Advisors. All rights reserved.
          </p>
