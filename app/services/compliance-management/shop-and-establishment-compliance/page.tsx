...
export default function ShopAndEstablishmentCompliance() {
  const services = [
    ...
    "Support in court/legal related matters"
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Shop & Establishment Compliance - Professional Team"
            fill
        ...
        <div className="max-w-7xl mx-auto w-full flex-1 flex items-center relative z-20">
          <div className="w-full max-w-3xl pb-16">
            ...
            >
              ...
              >
                Well defined systematic approach to handle compliance across multi-locations. Ensure your business operations remain compliant with all statutory requirements.
              </motion.p>
              ...
              >
                {[
                  { label: "Expert Team", value: "Multi-Location Support" },
      ...
      <section className="w-full bg-white py-16 lg:py-24 px-4 sm:px-6 lg:px-8 mt-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              <motion.p 
                ...
                transition={{ duration: 0.6, delay: 0.3 }}
              >
                Geographical spread and variations in state laws pose a challenge in ensuring compliance starting from registration of an establishment/branch to handling inspections by Government Officials. We support companies to obtain necessary exemptions for uninterrupted and hassle-free business operations.
              </motion.p>
